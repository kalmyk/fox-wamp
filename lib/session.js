...
function Session (gate, sender, sessionId) {
  ...
  */
  ...
  this.setDisconnectPublish = function (cmd) {
    willPublish = cmd
  }

  this.cleanDisconnectPublish = function () {
    willPublish = undefined
  }

  this.cleanup = function () {
    if (this.realm && willPublish) {
      this.realm.doPush(this, willPublish)
    }
