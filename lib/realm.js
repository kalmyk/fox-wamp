...
class TableDictionary {
  ...
  // setTableDef(tableName, struct) {
  //   let table = new TableCompute(this, struct, tableName)
  ...
  // load(dataArray) {
  //   this._tables.clear()
  //   for (let tableName in dataArray.table) {
  //     this.setTableDef(tableName, dataArray.table[tableName])
  //   }
  // }
  ...
  validateStruct (uri, data) {
    ...
    if (this._tables.has(tableName)) {
      this._tables.get(tableName).validateStruct(getBodyValue(data))
    }
  }
}
